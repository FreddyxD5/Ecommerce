        ...
        >
            ...
            <dl className="mt-6 space-y-4">
                ...
                <div className="border-t border-gray-200 pt-4 flex items-center justify-between">
                    ...
                    <dd className="text-sm font-medium text-gray-900">{shipping_cost && shipping_id !== 0 ? <>${shipping_cost}</> : <div className="text-red-500">Please select a shipping option</div>}</dd>
                </div>
                <div className="border-t border-gray-200 pt-4 flex items-center justify-between">
